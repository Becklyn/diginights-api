...
class Api
{
    ...
    private function deserializeEvent(array $eventData) : Event
    {
        ...
        if (\array_key_exists('location', $eventData) && null !== $eventData['location']) {
            $location = $this->deserializeLocation($eventData['location']);
        }

        $ticketSale = null;

        if (\array_key_exists('ticket_sale', $eventData) && null !== $eventData['ticket_sale']) {
            $ticketSale = $this->deserializeTicketSale($eventData['ticket_sale']);
        }
